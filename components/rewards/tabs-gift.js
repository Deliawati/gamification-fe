...
export default function TabsGift() {
    ...
    <>
      ...
      <div className="bg-white -mt-10 relative mx-9 rounded-md shadow1">
        <div className="flex flex-row">
          <Link href="/reward">
            <h6 className={router.pathname === '/reward' ? 'w-full text-center asu border-b-4 border-red-600 font-semibold text-red-600 py-4 cursor-pointer' : 'w-full text-center py-4 cursor-pointer text-gray-800'}>Lihat Penawaran Hadiah</h6>
          </Link>
          <Link href="/reward/my-gift">
            <h6 className={router.pathname === '/reward/my-gift' ? 'w-full text-center asu border-b-4 border-red-600 font-semibold text-red-600 py-4 cursor-pointer' : 'w-full text-center py-4 cursor-pointer text-gray-800'}>Hadiah Saya</h6>
          </Link>
        </div>
      </div>
    </>
